...
ActiveRecord::Schema.define(version: 2021_03_12_191058) do
  ...
  create_table "friendrequests", force: :cascade do |t|
    ...
    t.integer "pending_friend_id", null: false
    t.boolean "accepted", default: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["pending_friend_id"], name: "index_friendrequests_on_pending_friend_id"
